...
user3.dd_role(:member, room)
user4.add_role(:member, room)

game1 = room.games.create(recorded_at: 1.month.ago, user_id: user.id)
game1.records.create(player: p1, score: 100)
game1.records.create(player: p2, score: -200)
game1.records.create(player: p5, score: 100)

game2 = room.games.create(recorded_at: 2.weeks.ago, user_id: user1.id)
...
game3 = room.games.create(recorded_at: 3.days.ago, user_id: user2.id)
game3.records.create(player: p2, score: -700)
game3.records.create(player: p4, score: 500)
game3.records.create(player: p5, score: 200)

game4 = room.games.create(recorded_at: 1.day.ago, user_id: user.id)
